 ...
 * Call prediction API
 */
async function getPrediction(passenger) {
    try {
 ...
 */
function showResultsSection(survivalProbability) {
 ...
 */
function renderResults(isHopeful, percentage) {
    // Get DOM elements
    const skyBackground = document.querySelector('.results__background-sky');
    const character = document.querySelector('.results__character');
    const emphasis = document.querySelector('.results__emphasis');
    const percentageEl = document.querySelector('.results__percentage');
 ...
 */
function playResultAudio(isHopeful) {
...
function hideResultsSection() {
    const resultsSection = document.getElementById('results');
    const searchSection = document.getElementById('search');
    if (!resultsSection || !searchSection)
        return;
